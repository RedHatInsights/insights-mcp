...
description: Red Hat Lightspeed MCP tools via red-hat-lightspeed-mcp-cli subcommands.
metadata:
  openclaw:
    emoji: "🔧"
    homepage: https://github.com/RedHatInsights/insights-mcp
    requires:
      bins: ["red-hat-lightspeed-mcp-cli"]
      env: ["LIGHTSPEED_CLIENT_ID", "LIGHTSPEED_CLIENT_SECRET"]
---
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool get_mcp_version
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool image-builder__get_openapi --endpoints <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool image-builder__get_blueprints --limit <value> --offset <value> --search-string <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool image-builder__get_blueprint_details --blueprint-identifier <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool image-builder__get_composes --limit <value> --offset <value> --search-string <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool image-builder__get_compose_details --compose-identifier <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool image-builder__get_distributions
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool image-builder__get_org_id
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool rhsm__get_activation_keys --limit <value> --offset <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool rhsm__get_activation_key --name <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool vulnerability__get_openapi
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool vulnerability__get_cves --filter <value> --limit <value> --offset <value> --sort <value> --cvss-from <value> --cvss-to <value> --impact <value> --rule-presence <value> --known-exploit <value> --advisory-available <value> --affecting-host-type <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool vulnerability__get_cve --cve <value> --advisory-available <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool vulnerability__get_cve_systems --cve <value> --filter <value> --limit <value> --offset <value> --sort <value> --system-uuid <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool vulnerability__get_system_cves --system-uuid <value> --filter <value> --limit <value> --offset <value> --sort <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool vulnerability__get_systems --filter <value> --limit <value> --offset <value> --sort <value> --group-names <value> --rhel-versions <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool vulnerability__explain_cves --cves <value> --system-uuid <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool advisor__get_active_rules --impacting <value> --incident <value> --has-automatic-remediation <value> --impact <value> --likelihood <value> --category <value> --reboot <value> --sort <value> --offset <value> --limit <value> --groups <value> --tags <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool advisor__get_rule_from_node_id --node-id <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool advisor__get_rule_details --rule-id <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool advisor__get_hosts_hitting_a_rule --rule-id <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool advisor__get_hosts_details_for_rule --rule-id <value> --limit <value> --offset <value> --rhel-version <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool advisor__get_rule_by_text_search --text <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool advisor__get_recommendations_stats --groups <value> --tags <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool inventory__list_hosts --hostname-or-id <value> --display-name <value> --fqdn <value> --tags <value> --staleness <value> --registered-with <value> --provider-type <value> --updated-start <value> --updated-end <value> --per-page <value> --page <value> --order-by <value> --order-how <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool inventory__get_host_details --host-ids <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool inventory__get_host_system_profile --host-ids <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool inventory__get_host_tags --host-ids <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool inventory__find_host_by_name --hostname <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool content-sources__list_repositories --enabled <value> --limit <value> --offset <value> --name <value> --url <value> --content-type <value> --origin <value> --arch <value> --version <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool rbac__get_all_access --username <value> --limit <value> --offset <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool planning__get_upcoming_changes
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool planning__get_appstreams_lifecycle --mode <value> --major <value> --name <value> --application-stream-name <value> --application-stream-type <value> --kind <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool planning__get_rhel_lifecycle
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool planning__get_relevant_upcoming --major <value> --minor <value>
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool planning__get_relevant_appstreams --major <value> --minor <value> --include-related
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py call-tool planning__get_relevant_rhel_lifecycle --major <value> --minor <value> --include-related
```
...
```bash
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py list-tools
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py list-resources
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py read-resource <uri>
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py list-prompts
uv run --with fastmcp python red-hat-lightspeed-mcp-cli.py get-prompt <name> [key=value ...]
```
